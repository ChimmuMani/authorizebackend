package com.payment.authorize.controller;
...
import com.payment.authorize.model.PaymentAmount;
...
public class HostedFormController {
	...
	public ResponseEntity<Object> generateAPIToken(@RequestBody PaymentAmount paymentAmount)
		...
		setting.setSettingValue(
				"{\"showReceipt\": true, \"url\": \"https://chimmumani.github.io/authorize.et/success.html\", \"urlText\": \"Continue\", \"cancelUrl\": \"https://chimmumani.github.io/authorize.et/error.html\", \"cancelUrlText\": \"Cancel\"}");
		...
		setting3.setSettingValue("{\"bgColor\": \"Green\"}");
		...
		setting9.setSettingValue("{\"show\": true, \"merchantName\": \"ShipcarteTest\"}");

//		SettingType setting10 = new SettingType();
//		setting10.setSettingName("hostedPaymentIFrameCommunicatorUrl");
//		setting10.setSettingValue("{\"url\": \"https://chimmumani.github.io/authorize.et/IFrameCommunicator.html\"}");
